      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link
              href="/"
              className="text-lg font-bold uppercase tracking-[0.12em] text-foreground transition-colors"
            >
              Aaron Freeman
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              ...
              >
                {item.name}
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-[hsl(var(--gold))] transition-all duration-300 group-hover:w-full"></span>
              </Link>
            ))}
            <ThemeToggle />
          </nav>
